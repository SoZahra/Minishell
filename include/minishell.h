...
/*   Updated: 2024/12/28 15:18:09 by fzayani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int							handle_empty_token(t_token **tokens,
								t_token *token);
int							process_expandable_token(t_token **tokens,
...
int							check_operator_sequence(t_token **tokens, char type,
								int x);
...
void						handle_command_not_found(t_ctx *ctx, t_command *cmd,
								char **env_v);
...
int							add_argument(t_command *cmd, t_token *token,
								int *arg_idx);
int							is_argument(t_token_type type);
int							add_redir(t_command *cmd, t_token *token,
								int *redir_i);
